...
class PI4Logo:
    ...
    def draw_logo(self):
        # Simplified version of the Raspberry Pi logo on an 8x8 matrix
        logo = [
            # Raspberry shape (main circle)
            (2, 3), (2, 4), (3, 2), (3, 5), 
            (4, 1), (4, 6), (5, 1), (5, 6), 
            (6, 2), (6, 5), (7, 3), (7, 4),

            # Leaves or stem (top part)
            (1, 3), (1, 4), (1, 2), (1, 5),

            # Filling the interior of the raspberry shape
            (3, 3), (3, 4), (4, 2), (4, 3), (4, 4), (4, 5), 
            (5, 2), (5, 3), (5, 4), (5, 5),
            (6, 2), (6, 3), (6, 4)
        ]
...
def main():
    ...
    pi_logo = PI4Logo(device, 1)  # Set period to 1 second
    pi_logo.draw_logo()
